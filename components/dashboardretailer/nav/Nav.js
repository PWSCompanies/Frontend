...
export default function Nav() {
  ...
  return (
    <div className="bg-white md:rounded-xl md:border md:border-[#E3E5E5] flex flex-row md:flex-col gap-3 md:pb-5">
      {navcontent.map((data, index) => (
        <div
          key={index}
          className={`flex justify-start items-center gap-2 pl-4 cursor-pointer hover:bg-[#00BA34] hover:text-[#fff] py-3 ${
            selected === data.name
