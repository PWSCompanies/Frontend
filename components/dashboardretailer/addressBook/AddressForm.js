...
import { Button, CheckboxInputField, CustomSelect, FloatInputField, InputField } from "../../CustomComponent";
import { nigeriaData } from "../../eccormerce/cart/checkout/NigeriaData";
...
export default function AddressForm() {
  ...
  return (
    <div className="w-full h-full pt-3 sm:pt-0">
      <form className="" onSubmit={handleSubmit}>
          ...
          <div className="self-stretch justify-end items-end gap-[15px] flex pt-5">
